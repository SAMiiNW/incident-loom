...
def main():
    ...
    out={'contract':address,'deployTx':h,'network':'testnet-bradbury','version':'2.0','deployer':account.address};open(os.path.join(ROOT,'deployment.json'),'w',encoding='utf-8').write(json.dumps(out,indent=2));print(json.dumps(out),flush=True)
